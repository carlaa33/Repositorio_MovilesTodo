...
public class MyContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY =
            "com.ejemplos.database.provider.MyContentProvider";
        ...
        switch (uriType) {
            ...
            case PRODUCTS_ID:
                ...
                if (TextUtils.isEmpty(selection)) {
                    ...
                    rowsDeleted = sqlDB.delete(MyDBHandler.TABLE_PRODUCTS, MyDBHandler.COLUMN_ID + "=" + id
...
// TODO: Completar.
    ...
    public boolean onCreate() {
        MyDBHandler myDB = new MyDBHandler(getContext(), null, null, 1);
        return false;
    }
            ...
            case PRODUCTS_ID:
                ...
                if (TextUtils.isEmpty(selection)) {
                    ...
                    rowsUpdated = sqlDB.update(MyDBHandler.TABLE_PRODUCTS,
                            values, MyDBHandler.COLUMN_ID + "=" + id
                                    + " and " + selection, selectionArgs);
                }
                break;
            default:
